...
% Set all run parameters manually (workaround line 46)
...
%                'ListString',s1);            
% Choose option to select; all would be: Summed Tephra2 outputs, Probability outputs,
% Probablistic isomass
%r1 = [1, 2, 3];
% But for now select: Probability outputs, Probablistic isomass
r1 = [2, 3];
...
%                'SelectionMode','multiple',...
%                'ListString',s2);            
% Choose option to select; all would be: Columns, ASCII Grids, ArcMap ASCII Rasters
%r2 = [1, 2, 3];
% But for now select: ArcMap ASCII Rasters
r2 = [3];
